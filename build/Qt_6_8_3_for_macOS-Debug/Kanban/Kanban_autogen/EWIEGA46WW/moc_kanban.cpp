...
static constexpr auto qt_meta_stringdata_ZN6KanbanE = QtMocHelpers::stringData(
    "Kanban",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6KanbanE[] = {
...
Q_CONSTINIT const QMetaObject Kanban::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6KanbanE.offsetsAndSizes,
    qt_meta_data_ZN6KanbanE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6KanbanE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Kanban, std::true_type>,
...
void *Kanban::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6KanbanE.stringdata0))
