...
Q_CONSTINIT static const uint qt_meta_data_ZN8ReminderE[] = {
...
Q_CONSTINIT const QMetaObject Reminder::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8ReminderE.offsetsAndSizes,
    qt_meta_data_ZN8ReminderE,
    qt_static_metacall,
    nullptr,
...
void *Reminder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8ReminderE.stringdata0))
