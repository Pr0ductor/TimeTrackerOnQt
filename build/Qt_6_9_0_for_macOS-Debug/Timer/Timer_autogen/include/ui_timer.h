...
public:
    ...
    QLabel *label_8;
    QPushButton *DeclineButtonOnTimer;
...
"}"));
        ...
        label_7->setGeometry(QRect(997, 220, 450, 90));
        QFont font2;
...
"}"));
        ...
        textEdit->setGeometry(QRect(997, 360, 450, 149));
...
"padding: 0; /* \320\236\321\202\321\201\321\202\321\203\320\277\321\213 */\n"
"}"));
        DeclineButtonOnTimer = new QPushButton(centralwidget);
        DeclineButtonOnTimer->setObjectName("DeclineButtonOnTimer");
        DeclineButtonOnTimer->setGeometry(QRect(350, 600, 256, 41));
        DeclineButtonOnTimer->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"}"));
        ...
        StartButtonOnTimer->setGeometry(QRect(640, 600, 256, 41));
...
"}"));
    ...
    void retranslateUi(QMainWindow *Timer)
    {
        ...
        label_7->setText(QCoreApplication::translate("Timer", "00:10:00", nullptr));
        ...
        textEdit->setPlaceholderText(QCoreApplication::translate("Timer", "Add task that you want complete...", nullptr));
        ApplyTimerOnTimer->setText(QCoreApplication::translate("Timer", "Apply timer", nullptr));
        label_8->setText(QString());
        DeclineButtonOnTimer->setText(QCoreApplication::translate("Timer", "Decline", nullptr));
