...
namespace {
struct qt_meta_tag_ZN8ReminderE_t {};
} // unnamed namespace

template <> constexpr inline auto Reminder::qt_create_metaobjectdata<qt_meta_tag_ZN8ReminderE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Reminder, qt_meta_tag_ZN8ReminderE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Reminder::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8ReminderE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8ReminderE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8ReminderE_t>.metaTypes,
    nullptr
} };
...
void *Reminder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8ReminderE_t>.strings))
